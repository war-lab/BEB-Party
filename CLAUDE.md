...
対応人数はゲームごとに決める。収録済みの5本はいずれも5〜6人用である（[ADR-0026](docs/adr/0026-対象人数を2人から6人に広げる.md)）。
1つの部屋基盤に複数ゲームを載せる。収録済みは英語推理ゲーム「ENGLISH DETECTIVES」（人狼型）、禁止語を避けて人物を説明する「DON'T SAY IT」、秘密の目標を抱えて順位を議論する「ENGLISH RANKING」、匿名の英文から作者を当てる「WHO WROTE THIS?」、見えない配置を英語で伝えて同じ形を作る「BLIND ROOM」の5本。
