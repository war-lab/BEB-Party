<!--
  ...
  重複の記録: client/games/{dontsayit,ranking}/src/ScoreBoard.svelte とimport元以外が同一である。これで3つ目のコピーになる。
  ゲーム固有の語彙を持たないため、ADR-0020の条件を両方満たす。client/coreへ上げる作業は別PRで行う。
-->
<script lang="ts">
  import type { Room } from "@beb/shared-core";
  import { pointsOf, type ScoreEntry } from "@beb/shared-whowrotethis";
