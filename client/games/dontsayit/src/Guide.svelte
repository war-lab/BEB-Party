...
<h3>目的</h3>
<p>
  説明者が英語でお題を説明し、回答者が言い当てる。ただし説明者には使ってはいけない語が配られる。
  説明者と当てた人の両方に1点入るため、伝わる説明をしたほうが得になる。
</p>

<h3>3つの役</h3>
<ul>
  <li><strong>説明者</strong>: お題（英語名と日本語名）と禁止語が配られる。禁止語を使うと1点減る</li>
  <li><strong>監視役</strong>: 禁止語と正解が配られる。禁止語か正解そのものを言われたら「違反」を押す。このラウンドは答えない</li>
  <li><strong>回答者</strong>: 声を聞いてお題を言い当てる。当てると1点</li>
</ul>
...
<ul>
  <li>自分の画面を他人に見せない</li>
  <li>説明は英語で行う。言えない語の範囲は下に書いた</li>
  <li>回答は英語でも日本語でもよい。当てるのが目的である</li>
  <li>正解の申告は説明者が行う。誰が当てたかは説明者が選ぶ</li>
</ul>

<h3>言えない語の範囲</h3>
<p>説明者が言えないのは、赤で並んだ禁止語と、次の語です。</p>
<ul>
  <li>お題の名前そのもの（<b>Snow White</b>）</li>
  <li>名前を空白やハイフンで区切った語（<b>snow</b> / <b>white</b>）</li>
  <li>ひと続きの名前に含まれる語（<b>raincoat</b> の <b>rain</b> と <b>coat</b>、<b>lighthouse</b> の <b>light</b> と <b>house</b>）</li>
  <li>「この言い方も使えない」に出ている別名（<b>refrigerator</b> の <b>fridge</b>）</li>
</ul>
<p>
  たまたま名前の中に文字が並んでいるだけの語は言えます（<b>Katniss</b> の <b>cat</b>、<b>Bart</b> の <b>art</b> はセーフ）。
  意味のある語として名前を組み立てているかで分けます。
</p>
<p>日本語名は「何のお題か」を伝えるための表示です。日本語を口に出すのは、英語で説明していないので禁止です。</p>
...
<h3>正解の判定</h3>
<p>
  回答はカードの表記と一致しなくてかまいません。日本語読み・語順違い・広く通じる通称
  （キティちゃん、プーさん、エッフェル塔等）は、そのお題を一意に指していれば正解とします。
  人物のお題は、姓または名だけの回答でも、その人物を一意に指していれば正解です。
</p>
<p>
  種類や役割だけの回答は、お題を名指ししていないため正解にしません
  （「アナ雪」「鬼滅の主人公」「タワー」「掃除する道具」）。
</p>
<p>
  <strong>正解として受理する言い方は、説明者も言えません。</strong>
  fridge で refrigerator を、couch で sofa を当てられるなら、説明者がその語を言うのは正解そのものを言ったことになります。
  カードに別名がある場合は、説明者と監視役の画面に「この言い方も使えない」として出ます。
</p>
...
<ul class="phrases">
  ...
  <li><b>Is it a place?</b><span>それは場所？</span></li>
...
<ul class="phrases">
  ...
  <li><b>It is something you use to ...</b><span>〜するために使うものです</span></li>
  <li><b>It is a place where ...</b><span>〜する場所です</span></li>
