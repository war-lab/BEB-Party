...
export const SCRIPTS: MovieScript[] = [
  ...
  },
  {
    ...
    purpose: ["説明者1人だけが見本を見る", "他の全員は英語の説明を聞いて", "同じ並びを自分の盤面に作る"],
    beats: [
      {
        shot: "blindroom-briefing",
        stage: "部屋の確認（60秒）",
        caption: ["使うものの英語名を全員で見る", "盤面の広さはホストが選ぶ"],
        hold: 3.2,
      },
      {
        shot: "blindroom-handoff-cover",
        stage: "説明者の交代（30秒）",
        caption: ["見本は伏せ面のまま届く", "まわりを確認してから開く"],
        hold: 3.2,
      },
      {
        shot: "blindroom-handoff-sample",
        stage: "説明者の交代",
        caption: ["この並びを英語だけで伝える", "置くのは5個"],
        hold: 3.2,
      },
      {
        shot: "blindroom-building-describer",
        stage: "配置（既定75秒）",
        caption: ["マスに番号は無い", "top・left・next to で位置を言う"],
        hold: 3.4,
      },
      {
        shot: "blindroom-building-listener",
        stage: "配置",
        caption: ["聞き手は選んで置く", "分からなければ英語で聞き返す"],
        hold: 3.4,
      },
      {
        shot: "blindroom-reveal",
        stage: "答え合わせ（45秒）",
        caption: ["見本とみんなの盤面が並ぶ", "合っていたマスが点になる"],
        hold: 3.4,
      },
    ],
    scoring: [
      ["合ったマス1つにつき1点", "1ラウンド最大5点"],
      ["説明者は聞き手の平均が点になる", "伝わるほど自分の点も伸びる"],
      ["説明者を1人ずつ交代し、", "人数分くり返す"],
    ],
    promises: [
      ["説明者の画面を他の人が見ない"],
