...
const COMMON_INTRO: Beat[] = [
  {
    shot: "common-home",
    caption: "なまえと英語レベルを申告して部屋に入る",
    hold: 2.6,
  },
  {
    shot: "common-lobby",
    caption: "5〜6人が同じ部屋コードで集まる",
    hold: 2.6,
  },
];
...
export const SCRIPTS: MovieScript[] = [
  {
    ...
    purpose: "全員が事件の関係者。1人だけが犯人で、その証言には嘘が1枚混ざっている",
    beats: [
      ...COMMON_INTRO,
      {
        shot: "detectives-briefing",
        stage: "ブリーフィング",
        caption: "事件の概要は全員に同じものが出る",
        hold: 3.0,
      },
      {
  ...
  },
  {
    ...
    beats: [
      ...COMMON_INTRO,
      {
        ...
        stage: "ルール確認",
        caption: "説明者・監視役・回答者の3役を全員が順に回る",
        hold: 3.2,
      },
      {
    ...
    promises: [
      "自分の画面を他人に見せない",
      "禁止語は複数形・過去形にしても同じ語とみなす",
      "レベルが上がると使えない語が増える（3語→4語→5語＋条件）",
    ],
  },
  {
    id: "ranking",
    ...
    purpose: "5つの項目を英語で話し合って1位から5位に並べる。各自に秘密の目標がある",
    beats: [
      ...COMMON_INTRO,
      {
