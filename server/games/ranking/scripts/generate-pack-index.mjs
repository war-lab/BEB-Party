// content/ranking/ を走査して src/packs.generated.ts を生成する。
//
// お題パックの一覧は手動の目次ファイルを持たない（基本設計/10_ENGLISHRANKINGゲームモジュール.md）。
...
const contentDir = path.join(rootDir, "content", "ranking");
...
const imports = files.map((file) => `import ${identifierOf(file)} from "../../../../content/ranking/${file}";`);
